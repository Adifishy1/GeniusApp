...
const CodePage = () => {
    ...
    return (
        <div>
            ...
            description="Generate Code using descriptive tool"
            icon={Code}
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within shadow-sm grid grid-cols-12 gap-2">
                            <FormField name="prompt" render={({field}) => (<FormItem className="col-span-12 lg:col-span-10">
                                <FormControl className="m-0 p-0">
                                    <Input className="borde-0 outine-none focus-visible: ring-0 focus-visible:ring-transparent" placeholder="Simple toggle button using react hooks" disabled={isLoading} {...field}/>
                                </FormControl>
                            </FormItem>)}/>
